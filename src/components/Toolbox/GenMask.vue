  ...
  style="align-items: center">
    ...
    <div class="bg-white rounded-2xl overflow-hidden transition-all w-40 duration-300">
      ...
      <video
          ...
          muted
      >
        <source src="@/assets/gen_animation1.mp4" type="video/mp4">
      </video>
    </div>
  </div>
...
// 视频源 (使用占位符 - 实际使用时替换为真实URL)
const videoSource = ref("@asset/");
const videoPlayer = ref(null);

// 动态渐变背景 (从蓝紫色渐变到粉色)
const gradientBackground = ref({
  background: 'linear-gradient(135deg, #8e2de2, #4a00e0, #fc466b)',
